...
.left {background-color: #f66;height: 100px;}
.center {background-color: #9f9;height:150px;}
.right {background-color: #fc6; height: 200px;}
.top {background-color: #66f; height: 200px;}
.bottom {background-color: #cc6; height: 200px;}
